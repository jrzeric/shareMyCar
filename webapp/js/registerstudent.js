function initComboBoxes()
{
	...
	//prepare request
	x.open('GET', 'http://localhost/sharemycar/webapp/apis/state.php', true);
	//send request
	x.send();
...
function fillCities()
{
  ...
  console.log(idState);
  //prepare request
  x.open('GET', 'http://localhost/sharemycar/webapp/apis/city.php?state=' + idState, true);
  //send request
  x.send();
  //handle readyState change event
  x.onreadystatechange = function()
...
function fillUniversities()
{
  ...
  //prepare request
  x.open('GET', 'http://localhost/sharemycar/webapp/apis/university.php?city=' + idCity, true);
  //send request
  x.send();
  //handle readyState change event
  x.onreadystatechange = function()
