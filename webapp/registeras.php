...
<html>
  <head>
    ...
    <link href="/sharemycar/webapp/css/toogle.css" rel="stylesheet">
   ...
   <div class="container">
     <div class="radio-tile-group">
       ...
       <input type="radio" id="f-option"
               class="radio-button" name="selector" onclick="showOptions(this.value)" value="Passenger"/>
              <div class="radio-tile">
           <div class="icon bike-icon">
           </div>
           <label class="radio-tile-label" for="f-option">Passenger</label>      </div>
       </div>


       <div class="input-container">
          <input type="radio"  class="radio-button"  id="s-option" name="selector" onclick="showOptions(this.value)" value="Driver"/>      <div class="radio-tile">
           <div class="icon walk-icon">
                  </div>
           <label for="s-option" class="radio-tile-label">Driver</label>
         </div>
       </div>
